...
class WordEmbeddings:
    ...
    def get_initialized_embedding_layerWithoutGlove(self, frozen=False):
        """
        :param frozen: True if you want the embedding layer to stay frozen, false to fine-tune embeddings
        :return: torch.nn.Embedding layer you can use in your network
        """
        vocab_size = len(self.word_indexer)
        embedding_dim = 300
        return torch.nn.Embedding(vocab_size, embedding_dim)
    
    def get_initialized_embedding_layerWithoutGloveNew(self, vocab_size):
        """
        :param frozen: True if you want the embedding layer to stay frozen, false to fine-tune embeddings
        :return: torch.nn.Embedding layer you can use in your network
        """
